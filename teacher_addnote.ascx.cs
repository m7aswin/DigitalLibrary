...
public partial class t_note_add : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "select note_id from tb_id";
        SqlDataReader dr = db.executeread(cmd);
        dr.Read();
        int y = dr.GetInt32(0);
        y++;
        String cid = "NTE" + y.ToString();
        TextBox1.Text = cid;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        FileUpload1.SaveAs(Server.MapPath(@"~\note\" + FileUpload1.FileName.ToString()));
        String a = FileUpload1.FileName.ToString();
        dbconnection db7 = new dbconnection();
        
        cmd.CommandText = "insert into tb_note values(@a,@b,@c,@d,@e,@f)";
        ...
        cmd.CommandText = "update tb_id set note_id=@idd";
        cmd.Parameters.AddWithValue("@idd", y);
        db4.execute(cmd);
        Response.Redirect("teacher_addnote.aspx");
    }
}